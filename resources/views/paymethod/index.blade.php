    ...
    <div class="row">
        <div class="col-xs-12">
            <div >
                ...
                <br />
                <div align="left">
                    <button type="button" name="create_record" id="create_record" class="btn btn-primary">✚ Nuevo método</button>
                </div>
                <br />
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Agregar nuevo método</h4>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#create_record').click(function(){
                $('.modal-title').text("Agregar nuevo método");
